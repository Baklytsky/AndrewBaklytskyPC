...
export class GridSlider extends HTMLElement {
  constructor() {
    super();
  ...
  positionArrows() {
    const targetElement = this.slider.querySelector(selectors.productImage) || this.slider.querySelector(selectors.collectionImage) || this.slider.querySelector(selectors.columnImage) || this.slider;
