    ...
    */
    ...
    class Popout extends HTMLElement {
      ...
      connectedCallback() {
        ...
        this.fireSubmitEvent = this.hasAttribute(attributes$r.submit);
      ...
      onPopupToggleClick(evt) {
        ...
        const ariaExpanded = button.getAttribute(attributes$r.ariaExpanded) === 'true';
        ...
        evt.currentTarget.setAttribute(attributes$r.ariaExpanded, !ariaExpanded);
      ...
      popupOptionsClick(evt) {
        ...
        if (link.attributes.href.value === '#') {
          ...
          const attrValue = evt.currentTarget.hasAttribute(attributes$r.dataValue) ? evt.currentTarget.getAttribute(attributes$r.dataValue) : '';
          ...
          if (this.fireSubmitEvent) {
            ...
            const targetAttribute = this.popoutList.querySelector(`[${attributes$r.ariaCurrent}]`);
            ...
            if (targetAttribute && targetAttribute.hasAttribute(`${attributes$r.ariaCurrent}`)) {
              targetAttribute.removeAttribute(`${attributes$r.ariaCurrent}`);
              evt.currentTarget.setAttribute(`${attributes$r.ariaCurrent}`, 'true');
            }

            if (attrValue !== '') {
              this.popoutToggleText.innerHTML = attrValue;

              if (this.popoutToggleText.hasAttribute(attributes$r.popoutToggleText) && this.popoutToggleText.getAttribute(attributes$r.popoutToggleText) !== '') {
                this.popoutToggleText.setAttribute(attributes$r.popoutToggleText, attrValue);
              }
            }
      ...
      _hideList() {
        ...
        this.popoutToggle.setAttribute(attributes$r.ariaExpanded, false);
        this.toggleListPosition();
    ...
    */
    ...
    class DeferredMedia extends HTMLElement {
      ...
      mouseEnterActions() {
        ...
        if (!this.getAttribute(attributes$q.loaded)) {
          this.loadContent();
        }
      }
      ...
      loadContent(focus = true) {
        ...
        if (!this.getAttribute(attributes$q.loaded)) {
          ...
          if (mediaElement.nodeName == 'VIDEO' && mediaElement.getAttribute(attributes$q.autoplay)) {
    ...
    */
    ...
    class GridSlider extends HTMLElement {
      ...
      initArrows() {
        ...
        if (!this.buttons.length) {
          ...
          this.buttons = this.querySelectorAll(selectors$E.buttonArrow);
          this.buttonPrev = this.querySelector(`[${attributes$p.buttonPrev}]`);
          this.buttonNext = this.querySelector(`[${attributes$p.buttonNext}]`);
        }

        this.toggleArrowsObserver();

        if (this.hasAttribute(attributes$p.alignArrows)) {
          this.positionArrows();
      ...
      buttonArrowClickEvent(e) {
        ...
        if (e.target.hasAttribute(attributes$p.buttonPrev)) {
          slide = firstVisibleSlide?.previousElementSibling;
        }

        if (e.target.hasAttribute(attributes$p.buttonNext)) {
    ...
    class CountdownTimer extends HTMLElement {
      constructor() {
        ...
        this.expirationBehavior = this.getAttribute(attributes$o.expirationBehavior);
      ...
      onComplete() {
        ...
        if (this.shouldShowMessage) {
          ...
          if (this.closest(selectors$D.tickerText).hasAttribute(attributes$o.clone)) return;
    ...
    class Slider {
      constructor(container, slideshow = null) {
        ...
        this.multipleSlides = this.slideshow.hasAttribute(attributes$h.slidesLargeDesktop);
      ...
      onBlockSelect(evt) {
        ...
        if (this.multipleSlides && !this.slideshow.classList.contains(classes$l.sliderInitialized)) {
          slideIndex = 0;
        }
