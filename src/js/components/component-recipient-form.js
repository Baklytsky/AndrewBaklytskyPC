  ...
  customElements.define(
    ...
    class RecipientForm extends HTMLElement {
      constructor() {
        ...
        this.emailInput.addEventListener('input', (e) => this.onEmailInput.bind(this)(e));
        this.onChange();


        if (Datepicker) {
          const datepicker = new Datepicker(this.sendOnInput, {
            minDate: Date.now(),
            format: 'mm-dd-yyyy'
          });
        }
      ...
      onEmailInput(e) {
        ...
        const errorTextElement = e.target.closest('.recipient-fields__field').querySelector('.error-message');
        if (!errorTextElement) return;
        errorTextElement.innerText = 'Email is invalid.';
      }
