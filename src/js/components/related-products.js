  ...
  customElements.define(
    ...
    class Related extends HTMLElement {
      ...
      loadRelatedProducts() {
        ...
        const requestUrl = `${window.Shopify.routes.root}recommendations/products?section_id=api-product-recommendation&limit=${limit}&product_id=${productId}&intent=related`;
