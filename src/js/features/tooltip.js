...
export default class Tooltip {
  ...
  addPin(stopMouseEnter = false) {
    ...
    const section = this.tooltip.closest(selectors.sectionId);
    ...
    if (this.label && tooltipTarget && ((stopMouseEnter && !this.tooltip.hasAttribute(selectors.tooltipStopMouseEnter)) || !stopMouseEnter)) {
